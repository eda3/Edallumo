...
pub fn preprocess_json(json: String) -> String {
    ...
    result = result
        ...
        .replace(r#""Draw""#, r#""ブックマーク(ドロー)""#)
        .replace(r#""Discard""#, r#""ブックマーク(破棄)""#)
        // アクセル
        .replace(r#""Snail""#, r#""蝸牛""#)
        .replace(r#""Whistling Wind""#, r#""虎落笛""#)
        .replace(r#""Rainwater""#, r#""潦""#)
        .replace(r#""Whistling Wind (Charged)""#, r#""溜め虎落笛""#)
        .replace(r#""Winter Mantis""#, r#""冬蟷螂""#)
        .replace(r#""Air Snail""#, r#""空中蝸牛""#)
        .replace(r#""Axl Bomber""#, r#""アクセルボンバー""#)
        .replace(r#""Sickle Flash""#, r#""鎌閃撃""#)
        .replace(r#""Spinning Chain Strike""#, r#""旋鎖撃""#)
        .replace(r#""Soaring Chain Strike""#, r#""曲鎖撃""#)
        .replace(r#""Winter Cherry""#, r#""鬼灯""#)
        .replace(r#""Sickle Storm""#, r#""百重鎌焼""#)
        .replace(r#""One Vision""#, r#""ワンヴィジョン""#)
        // 梅喧
        .replace("23S", "236S")
        .replace(r#""Ground Throw (Tether)""#, r#""投げ""#)
        .replace(r#""Ground Throw (Knockback)""#, r#""溜め投げ""#)
        ...
        .replace(r#"bt."#, r#"bt"#)
        .replace(r#""Stahl Wirbel""#, r#""シュタイルヴァービル""#)
        .replace(r#""name":"bt66""#, r#""name":"ブリュンヒルデの構え66""#)
        .replace(r#""name":"bt44""#, r#""name":"ブリュンヒルデの構え44""#)
        .replace(r#""name":"btK""#, r#""name":"ブリュンヒルデの構えK""#)
        .replace(r#""name":"btP""#, r#""name":"ブリュンヒルデの構えP""#)
        .replace(r#""name":"btS""#, r#""name":"ブリュンヒルデの構えS""#)
        .replace(r#""name":"btHS""#, r#""name":"ブリュンヒルデの構えHS""#)
        // メイ
